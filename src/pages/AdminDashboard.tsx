...
export default function AdminDashboard() {
  ...
  const [activeTab, setActiveTab] = useState<'requests' | 'cities' | 'products' | 'orders'>('requests');
        ...
        <div className="p-8">
          ...
          <>
            <div className="mb-6">
              ...
              <p className="text-gray-600">Total paid orders: {paidOrders.length}</p>
            </div>
                  ...
                  >
                    <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 mb-4">
                      ...
                      <div>
                        ...
                        <p className="text-xs text-gray-600">Rental: {order.rentalDays} days</p>
                        <p className="text-xs text-gray-600">{order.deliveryMethod === 'pickup' ? 'Pickup' : 'Delivery'}</p>
                      </div>
                      ...
                      <div>
                        ...
                        {order.deliveryMethod === 'pickup' ? (
                          <p className="text-xs text-gray-600">Pickup: {order.pickupAddress || 'N/A'}</p>
                        ) : (
                          <>
                            <p className="text-xs text-gray-600">Delivery: {order.address || 'N/A'}</p>
                            {order.distance && (
                              <p className="text-xs text-gray-600">{order.distance.toFixed(1)} miles</p>
                            )}
                          </>
                        )}
                      </div>
                      ...
                      <div>
                        ...
                        <p className="text-xs text-gray-600">Status: <span className="text-green-600 font-medium">{order.status}</span></p>
                        <p className="text-xs text-gray-500 mt-1">
                          Payment ID: {order.paymentIntentId?.substring(0, 20)}...
                        </p>
                      </div>
                    </div>
